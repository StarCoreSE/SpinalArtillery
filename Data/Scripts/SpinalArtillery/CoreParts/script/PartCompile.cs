...
using static SpinalArtillery.CoreParts.Structure.WeaponDefinition.AnimationDef.RelMove;
using static SpinalArtillery.CoreParts.Structure.WeaponDefinition.AnimationDef.PartAnimationSetDef;
using static SpinalArtillery.CoreParts.Structure.WeaponDefinition.AnimationDef;
using static SpinalArtillery.CoreParts.Structure.WeaponDefinition.AnimationDef.PartAnimationSetDef.EventTriggers;
...
namespace SpinalArtillery.CoreParts
{
    partial class Parts
    {
        ...
        {
            baseDefs = new CoreParts.Parts().Container;
        }
